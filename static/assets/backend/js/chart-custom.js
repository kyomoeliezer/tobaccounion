...
if(jQuery('#home-perfomer-chart').length){
	var used_tickets = 50
var available_tickets = 50
        var donut = new Morris.Donut({
          element: 'home-perfomer-chart',
          resize: true,
          colors: ["#fe517e","#99f6ca"],
          data: [
            {label: "Used Tickets", value:document.getElementById("used_tickets").innerHTML},
            {label: "Available Tickets", value: document.getElementById("available_tickets").innerHTML},
          ],
          hideHover: 'auto'
        });
    }
    ...
    if(jQuery('#iq-income-chart').length){
    	var options = {
          ...
          data: ["{% for shipment in shipments %}"]
        }],
          chart: {
          type: 'bar',
          height: 350,
